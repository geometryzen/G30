...
var Bivector3 = (function () {
    ...
    Bivector3.prototype.add = function (B) {
        mustBeBivectorE3_1.mustBeBivectorE3('B', B);
        this.yz += B.yz;
        this.zx += B.zx;
        this.xy += B.xy;
    ...
    */
    ...
    Bivector3.prototype.wedge = function (a, b) {
        mustBeVectorE3_1.mustBeVectorE3('a', a);
        mustBeVectorE3_1.mustBeVectorE3('b', b);
    ...
    Bivector3.prototype.__add__ = function (rhs) {
        if (isBivectorE3_1.isBivectorE3(rhs) && !isVectorE3_1.isVectorE3(rhs)) {
