...
var inv3x3_1 = require("./inv3x3");
var mul3x3_1 = require("./mul3x3");
/**
 *
 */
var Matrix3 = (function (_super) {
    ...
    Matrix3.prototype.inv = function () {
        inv3x3_1.inv3x3(this.elements, this.elements);
        return this;
    };
    /**
     * @param rhs
    ...
    Matrix3.prototype.rmul = function (lhs) {
        mul3x3_1.mul3x3(lhs.elements, this.elements, this.elements);
        return this;
    };
    /**
     * @param a
    ...
    Matrix3.prototype.mul2 = function (a, b) {
        mul3x3_1.mul3x3(a.elements, b.elements, this.elements);
        return this;
    };
    /**
