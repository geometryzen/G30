...
var Vec3 = (function () {
    ...
    function Vec3(x, y, z, uom) {
        this.x_ = mustBeNumber_1.mustBeNumber('x', x);
        this.y_ = mustBeNumber_1.mustBeNumber('y', y);
        this.z_ = mustBeNumber_1.mustBeNumber('z', z);
    ...
    Vec3.prototype.distanceTo = function (point) {
        ...
        return new Scalar3_1.Scalar3(a, uom);
    };
    /**
     * @returns this | v
     */
    ...
    Vec3.prototype.nearEqual = function (v, tolerance) {
        if (veryDifferent_1.veryDifferent(this.x_, v.x, tolerance)) {
            return false;
        }
        if (veryDifferent_1.veryDifferent(this.y_, v.y, tolerance)) {
            return false;
        }
        if (veryDifferent_1.veryDifferent(this.z_, v.z, tolerance)) {
            return false;
        }
        return true;
    };
