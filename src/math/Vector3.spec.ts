...
describe("Vector3", function () {
    describe("", function () {
        const s = Spinor3.spinor(1 / Math.SQRT1_2, 0, 0, 1 / Math.SQRT1_2).normalize();
        const m = Matrix3.zero().rotation(s);
        const u = Vector3.vector(1, 0, 0, Unit.METER).applyMatrix(m);
        const v = Vector3.vector(1, 0, 0, Unit.METER).rotate(s);
        it("", function () {
...
describe("Vector3", function () {
    describe("constructor", function () {
        ...
        const vec = Vector3.vector(data[0], data[1], data[2], void 0);
    ...
    describe("operator", function () {
        describe("__add__", function () {
            const a = Vector3.vector(1, 2, 3, void 0);
            const b = Vector3.vector(3, 2, 1, void 0);
            const q = a.__add__(b);
        ...
        describe("__sub__", function () {
            const a = Vector3.vector(6, 4, 2, void 0);
            const b = Vector3.vector(3, 2, 1, void 0);
            const q = a.__sub__(b);
            it("(rhs is vector)", function () {
                expect(q.x).toBe(3);
        ...
        describe("__rsub__", function () {
            const a = Vector3.vector(3, 2, 1, void 0);
            const b = Vector3.vector(6, 4, 2, void 0);
        ...
        describe("__div__", function () {
            const a = Vector3.vector(2, 4, 6, void 0);
            const α = 2;
            const q = a.__div__(α);
            it("(rhs is number)", function () {
                expect(q.x).toBe(1);
